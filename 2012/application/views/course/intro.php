...
<div class="video-js-box">
  ...
  <video id="video" class="video-js" width="640" height="360" controls="controls" preload="auto" poster="/2012/assets/images/6470_video_logo.png">
    ...
    <source src="<?php echo URL::site('assets/videos/web_overview/'.$VIDEO_FILE_NAME.'.ogg'); ?>" type='video/ogg; codecs="theora, vorbis"' />
  ...
  <p class="vjs-no-video"><strong>Download Video:</strong>
    <a href="<?php echo URL::site('assets/videos/web_overview/'.$VIDEO_FILE_NAME.'.mp4'); ?>">MP4</a>,
